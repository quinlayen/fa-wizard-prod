...
const Hero = () => {
  return (
    <section className="max-w-7xl mx-auto bg-base-100 flex flex-col lg:flex-row items-center justify-center gap-16 lg:gap-20 px-8 py-8 lg:py-20">
      <div className="flex flex-col gap-10 lg:gap-14 items-center justify-center text-center lg:text-left lg:items-start">
        ...
        {/* <ul className="mt-8 space-y-4">
          <li className="flex items-start">
            <span className="inline-block text-white bg-[#FDB913] rounded-full p-.5">
              ✔️
            </span>
            <p className="ml-3 text-lg text-black">
              A Policy and Procedure manual with 30+ required statements, compliant with Title IV, accreditor, and state rules.
            </p>
          </li>
          <li className="flex items-start">
            <span className="inline-block text-white bg-[#FDB913] rounded-full p-.5">
            ...
            <p className="ml-3 text-lg text-black">
              "Financial Aid" and "Consumer Information" pages with required Title IV disclosures, matching your site's format and colors.
            </p>
          </li>
          <li className="flex items-start">
            <span className="inline-block text-white bg-[#FDB913] rounded-full p-.5">
            ...
            <p className="ml-3 text-lg text-black">
              An automated calendar to remind staff of upcoming federal deadlines, reports, and administrative tasks.
            </p>
          </li>
        </ul> */}
      ...
      <div className="lg:w-full flex flex-col items-center justify-center gap-8">
